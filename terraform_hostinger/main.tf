...
resource "null_resource" "hostinger_vps_deploy" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "cd /var/www/assessments/assessments && /var/www/assessments/venv/bin/pip install --upgrade pip gunicorn gevent greenlet && /var/www/assessments/venv/bin/pip install -r requirements.txt || true",
