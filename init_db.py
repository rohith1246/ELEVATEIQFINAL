...
try:
    ...
    import bcrypt
    # Check if employee user exists, if not seed it
    ...
    if not employee_row:
        ...
        conn.commit()
        print("Employee user seeded (bathikadileep@gmail.com / test1234)")
    else:
        emp_user_id = employee_row[0]

    # Check if candidate/student user exists, if not seed it
    ...
    if not candidate_row:
        ...
        conn.commit()
        print("Student user seeded (rohith@gmail.com / test1234)")
    else:
